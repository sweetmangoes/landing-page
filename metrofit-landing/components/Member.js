...
export default function Member() {
  ...
  return (
    <div className="bg-white w-full flex justify-center items-center
                    lg:h-[90vh]">
      <div className="h-full w-[94%] flex flex-col items-center p-5
                      lg:border-[3px] lg:rounded-[3rem] lg:border-black lg:h-[90%] lg:flex-row lg:p-0">
        <div className="h-full bg-no-repeat bg-center bg-contain bg-[url('../public/images/member-bg.svg')]
                        lg:w-[49.3%] lg:rounded-[3rem]">
          <p className="font-monomaniac text-[8rem] leading-[6rem] text-black p-8 mt-4 lg:mt-0">BE A<br /> MEMBER</p>
        </div>
        ...
        <div className="lg:w-[49.3%] h-full rounded-[3rem] p-5 flex flex-col text-center justify-center lg:text-left">
          <p className="font-montserrat text-[3rem] leading-[2.5rem]  lg:text-[4.5rem] lg:leading-[4.5rem] text-black p-8"><b>Affordable,<br />accessible,<br />and flexible<br />classes for all.</b></p>
          <div className="flex mt-[6rem] justify-center">
